...
START /WAIT cmd.exe /K "%sumo_path%\tools\randomTrips.py -n %map_path%\test.net.xml -o %trips_path%\test.trips.xml -r %trips_path%\test.rou.temp.xml -p 0.12 --validate --vclass="passenger" --vehicle-class="passenger" & PAUSE & EXIT 0"
