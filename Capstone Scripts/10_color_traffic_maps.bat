...
SET destination_path=%osm_path%\info

START /WAIT cmd.exe /K "%sumo_path%\tools\visualization\plot_net_dump.py -n %osm_path%\island.net.xml -i %data_path%\modified.dump.xml,%data_path%\modified.dump.xml -o %destination_path%\island_colormap.google.png -m diff_speed_ratio,occupancy --default-color #808080 --default-width 2 --min-color-value 0.0 --max-color-value 1.0 --min-width-value 0.0 --max-width-value 100.0 --colormap #0:#00cc00,0.229999:#00cc00,0.23:#ff6600,0.539999:#ff6600,0.54:#ff0000,0.919999:#ff0000,0.92:#660000,1:#660000 --min-width 2 --max-width 2 --size 50,50 --xlim 2000,22000 --ylim -5000,21000 -b -v & EXIT 0"
