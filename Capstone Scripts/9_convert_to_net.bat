...
START cmd.exe /K "%sumo_path%\netconvert -n %plain_path%\graphviz.nod.xml -e %plain_path%\graphviz.edg.xml -x %plain_path%\graphviz.con.xml -i %plain_path%\graphviz.tll.xml -o %destination_path%\graphviz.net.xml -v --ignore-errors --ignore-errors.edge-type -X "never" -W & PAUSE & EXIT 0"