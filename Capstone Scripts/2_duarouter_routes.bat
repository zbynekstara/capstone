...
START cmd.exe /K "%sumo_path%\duarouter -n %osm_path%\island.net.xml -t %data_path%\island.trips.xml -o %destination_path%\island.rou.xml --ignore-errors -b 0 -e 3600 --no-step-log --no-warnings & PAUSE & EXIT 0"