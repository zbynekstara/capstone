...
START /WAIT cmd.exe /K "%sumo_path%\duarouter -n %map_path%\island.net.xml -t %trips_path%\island.trips.xml -o %routes_path%\island.rou.xml --ignore-errors -b 0 -e 3600 --no-step-log --no-warnings & PAUSE & EXIT 0"
